...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty($customer_name) || empty($customer_phone) || empty($sales_qty) || empty($amount) || empty($sales_date)) {
        echo "All fields are required.";
        exit();
    }

    // SQL query for inserting into sales table
    $insert_sales_query = "INSERT INTO sales (customer_name, customer_phone, sales_qty, amount, notes, sales_date)
                             VALUES (:customer_name, :customer_phone, :sales_qty, :amount, :notes, :sales_date)";
    
    // Prepare and execute statement
    $stmt = $connection->prepare($insert_sales_query);
    ...
    if ($stmt->execute()) {
        ...
        error_log("Sales insertion failed: " . implode(" | ", $stmt->errorInfo()));
        throw new Exception("Sales insertion failed.");
    }
...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>Add Sales - Rongai Poultry</title>
                  ...
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                      ...
                      <li class=" ">
                          <a href="#product" class="collapsed" data-toggle="collapse" aria-expanded="false">
                              <svg class="svg-icon" id="-dash2" width="20" height="20"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Add Hatchery Sales</h4>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="sales_qty" class="form-control" placeholder="Enter Sales Quantity" required>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Date *</label>
                                    <input type="date" name="sales_date" class="form-control" placeholder="Enter Sales Date" required>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Notes *</label>
                                    <textarea name="notes" class="form-control" rows="2" placeholder="Enter Notes" required></textarea>
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-primary mr-2">Add Sales</button>
