...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>List Sales - Rongai Poultry</title>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <h4 class="mb-3">Hatchery Sales Overview</h4>
                    <p class="mb-0">The hatchery sales list effectively dictates sales representation and provides data<br> to show your hatchery sales records performance.</p>
                </div>
                <a href="add-sales.php" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Add Sales</a>
            </div>
        </div>
        <div class="container-fluid">
